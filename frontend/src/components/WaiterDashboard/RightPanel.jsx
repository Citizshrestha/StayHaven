...
import { Plus, X, Minus, CheckCircle, AlertCircle, Package, Phone, Bell, Sparkles, MapPin, User, Utensils, Bed } from "lucide-react";
...
const RightPanel = ({ orders = [] }) => {
  ...
  const assignedAreas = useMemo(() => {
    ...
    return Array.from(areaMap.values())
      ...
      .sort((a, b) => new Date(b.latestOrderTime) - new Date(a.latestOrderTime))
      .slice(0, 5);
  }, [orders]);
  ...
  // Get the top 5 latest notifications from context
  ...
  }, [contextNotifications, isDark]);  // ✅ Fixed: Added closing bracket and dependencies
              ...
              <div style={{ marginBottom: "24px" }}>
                ...
                <div style={{ position: "relative" }}>
                  <span style={{
                    ...
                    fontSize: "18px"
                  }}><MapPin size={18} color={colors.textTertiary} /></span>
                  <input
                    type="text"
                ...
                <div style={{ marginBottom: "16px" }}>
                  ...
                  <div style={{ position: "relative" }}>
                    <span style={{
                      ...
                      transform: "translateY(-50%)",
                      fontSize: "18px"
                    }}><User size={18} color={colors.textTertiary} /></span>
                    <input
                      type="text"
                      name="customerName"
                ...
                <div>
                  ...
                  <div style={{ position: "relative" }}>
                    <span style={{
                      ...
                      transform: "translateY(-50%)",
                      fontSize: "18px"
                    }}><Phone size={18} color={colors.textTertiary} /></span>
                    <input
                      type="tel"
                      name="customerPhone"
