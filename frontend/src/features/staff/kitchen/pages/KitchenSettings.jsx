...
import "../../waiter/pages/settings/WaiterSettings.css";

const KitchenSettings = ({ onClose, isDarkMode, onToggleDarkMode }) => {
  ...
  const handleSave = () => {
    ...
    // Apply theme on save
    const newIsDark = settings.theme === "dark";
    ...
    <div className="ws-container">
      ...
      <div className="ws-content">
        ...
        <div className="ws-profile-section">
          ...
          >
            <img
              src={staffUser?.profilePicture || `https://ui-avatars.com/api/?name=${encodeURIComponent(staffUser?.fullname || 'Chef')}&background=10B981&color=fff`}
              alt="Profile"
