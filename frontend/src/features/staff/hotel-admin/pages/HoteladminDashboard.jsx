...
const HoteladminDashboard = () => {
      ...
      <div style={{gap: "24px", marginBottom: "32px"}} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <div style={{marginBottom: "16px"}} className="flex items-center justify-between">
            <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-indigo-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-indigo-500/20">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-lg shadow-purple-500/20">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-amber-500 to-orange-500 flex items-center justify-center shadow-lg shadow-amber-500/20">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div style={{display: "flex", flexDirection: "column", gap: "12px", maxHeight: "220px", overflowY: "auto", paddingRight: "8px"}}>
            {topSellingItems.map((item, index) => (
              <div key={index} style={{padding: "12px", display: "flex", alignItems: "center", gap: "16px"}} className="rounded-xl bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer">
                <span className="w-8 h-8 flex items-center justify-center rounded-xl bg-linear-to-br from-indigo-500 to-indigo-600 text-white text-xs font-bold shadow-sm">
                  {index + 1}
                </span>
                ...
                <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                  ...
                  <td style={{padding: "16px 24px"}}>
                    <div style={{gap: "12px"}} className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-linear-to-br from-gray-200 to-gray-300 dark:from-gray-600 dark:to-gray-700 flex items-center justify-center text-xs font-semibold text-gray-600 dark:text-gray-300">
  ...
  const renderRoomsManagement = () => (
    <div className="rooms-content rooms-page-wrap">
      <div className="content-header rooms-content-header">
        <h1>Rooms Management</h1>
        <p className="subtitle">Manage all rooms, their status, and details.</p>
      </div>

      {/* Room Statistics - match Dashboard KPI card design */}
      <div className="room-stats room-stats-grid">
        <div className="room-kpi-card">
          <div className="room-kpi-top">
            <div className="room-kpi-icon room-kpi-icon-total">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
            </div>
            <span className="room-kpi-trend room-kpi-trend-up">+12%</span>
          </div>
          <div className="room-kpi-number">{roomStats.total}</div>
          <span className="room-kpi-label">Total rooms</span>
        </div>

        <div className="room-kpi-card">
          <div className="room-kpi-top">
            <div className="room-kpi-icon room-kpi-icon-available">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <span className="room-kpi-trend room-kpi-trend-neutral">Active</span>
          </div>
          <div className="room-kpi-number">{roomStats.available}</div>
          <span className="room-kpi-label">Available</span>
        </div>

        <div className="room-kpi-card">
          <div className="room-kpi-top">
            <div className="room-kpi-icon room-kpi-icon-occupied">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
              </svg>
            </div>
            <span className="room-kpi-trend room-kpi-trend-amber">In use</span>
          </div>
          <div className="room-kpi-number">{roomStats.occupied}</div>
          <span className="room-kpi-label">Occupied</span>
        </div>

        <div className="room-kpi-card">
          <div className="room-kpi-top">
            <div className="room-kpi-icon room-kpi-icon-maintenance">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span className="room-kpi-trend room-kpi-trend-amber">Ongoing</span>
          </div>
          <div className="room-kpi-number">{roomStats.maintenance}</div>
          <span className="room-kpi-label">Under maintenance</span>
        </div>
      </div>
