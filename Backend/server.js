...
// import staffRoutes from "./routes/staffRoutes.js"; // Temporarily disabled due to merge conflicts
...
// app.use("/api/staff", staffRoutes); // Temporarily disabled due to merge conflicts
